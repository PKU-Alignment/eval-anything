...
from third_party.SPOC.utils.constants.object_constants import AI2THOR_OBJECT_TYPE_TO_WORDNET_SYNSET
...
from third_party.SPOC.utils.constants.template_verbs import GOTO_POINT_VERBS, GOTO_VERBS, PICKUP_VERBS
from third_party.SPOC.utils.objaverse_annotation import get_objaverse_annotations
from third_party.SPOC.utils.synset_utils import (
    generate_all_hypernyms_with_exclusions,
    get_all_synsets_in_spoc,
)
from third_party.SPOC.utils.type_utils import REGISTERED_TASK_PARAMS
...
# )["train"].data
SYNSET_TO_BEST_LEMMA = json.load(open("third_party/SPOC/utils/synset_to_best_lemma.json", "r"))

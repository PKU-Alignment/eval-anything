...
from third_party.SPOC.spoc_model.preprocessors import (
    Preprocessor,
    PreprocessorConfig,
    tensor_image_preprocessor,
)
from third_party.SPOC.spoc_model.text_cond_visual_encoder import (
    PositionalEncoder,
...
from third_party.SPOC.utils.constants.stretch_initialization_utils import ALL_STRETCH_ACTIONS
from third_party.SPOC.utils.sensor_constant_utils import is_a_visual_sensor, is_a_non_visual_sensor
...
class EarlyFusionCnnTransformer(PreTrainedModel):
    ...
    def __init__(
        ...
        self.visual_encoder = TextCondMultiCameraVisualEncoder(
    ...
    def build_model(
        ...
        weights = load_file(ckpt_pth + '/model.safetensors')

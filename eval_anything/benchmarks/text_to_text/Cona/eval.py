...
from eval_anything.benchmarks.text_to_text.Cona.utils import EVALUATE_PROMPT, check_eval_response
...
class Cona(T2TBenchmark):
    ...
    def to_InferenceInput(self, task_list: list[str]) -> dict[str, list[InferenceInput]]:
        ...
        dataset = load_dataset(
            'json',
            data_files='eval-anything/eval_anything/benchmarks/safedata/split_instructions.json',
            split='train',
        )
    ...
    def to_EvaluationResult(
        ...
        self.display_benchmark_results(
            self.benchmark_name, {'Cona': {'Safety Rate': {'default': asr}}}
        )

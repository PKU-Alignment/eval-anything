...
class Anthropics(T2TBenchmark):
    ...
    def to_InferenceInput(self, task_list: list[str]) -> dict[str, list[InferenceInput]]:
        ...
        dataset = load_dataset('json', data_files='/share/project/znh/eval-anything/eval_anything/benchmarks/safedata/output.json', split='train')
    ...
    def to_EvaluationResult(
        ...
        self.display_benchmark_results(self.benchmark_name, {"Anthropics": {"Safety Rate": {"default": asr}}})

...
if TYPE_CHECKING:
    ...
    from third_party.SPOC.tasks.abstract_task_sampler import AbstractSPOCTaskSampler
...
from third_party.SPOC.utils.type_utils import RewardConfig, THORActions

from third_party.SPOC.utils.data_generation_utils.navigation_utils import get_room_id_from_location
from third_party.SPOC.utils.distance_calculation_utils import position_dist
from third_party.SPOC.utils.sel_utils import sel_metric
...
class AbstractSPOCTask(Task["StretchController"]):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.objects_causing_cost_list = []

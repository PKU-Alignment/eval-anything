...
class aegis_aicontent_safety_dataset(T2TBenchmark):
    ...
    def to_InferenceInput(self, task_list: list[str]) -> dict[str, list[InferenceInput]]:
        ...
        # assert self.data_path == 'nvidia/Aegis-AI-Content-Safety-Dataset-2.0'
    ...
    def to_InferenceOutput(
        ...
        for output_item, eval_item in zip(inference_outputs['aegis_aicontent_safety_dataset'], eval_response):
            try:

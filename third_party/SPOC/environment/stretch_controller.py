...
from third_party.SPOC.environment.spoc_objects import SPOCObject
from third_party.SPOC.environment.stretch_state import StretchState
...
from third_party.SPOC.utils.data_generation_utils.navigation_utils import (
...
from third_party.SPOC.utils.distance_calculation_utils import sum_dist_path, position_dist
from third_party.SPOC.utils.synset_utils import is_hypernym_of
from third_party.SPOC.utils.type_utils import THORActions, Vector3
...
class StretchController:
    ...
    def get_top_down_path_view(self, agent_path, cost_robot, cost_object, targets_to_highlight=None):
        ...
        return path[:, cutoff:-cutoff, :], agent_path, cost_robot, cost_object

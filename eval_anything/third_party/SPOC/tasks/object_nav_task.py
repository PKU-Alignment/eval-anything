...
from eval_anything.third_party.SPOC.utils.reward_shaper import ObjectNavRewardShaper
from eval_anything.third_party.SPOC.utils.type_utils import RewardConfig
...
class ObjectNavTask(AbstractSafeTask):
